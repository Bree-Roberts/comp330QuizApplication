...
public class WriteQues {
    ...
    public void writeMultipleChoice(
            String question, ArrayList<String> incorrectAnswers, String correctAnswer) {
        Map<String, String> answerMap = new LinkedHashMap<>();
        answerMap.put(correctAnswer, "C");
        for (String answer : incorrectAnswers) {
            answerMap.put(answer, "I");
        }
