...
public class WriteQues {
  ...
  public void promptUser(Scanner in, PrintStream out, String fileName)
      throws FileNotFoundException {

    JSONObject jo = new JSONObject();
    boolean done = false;
    ArrayList<String> options =
        new ArrayList<>(Arrays.asList("true false", "matching", "multiple choice"));
  ...
  private void createMatching(Scanner in, PrintStream out, JSONObject jo) {
    ...
    String statement;
    String answer;
    out.println("Please enter a word or statement: ");
    statement = in.nextLine();
    while (!done) {
      // TODO statement confirmation
      out.print("Enter the matching word or statement: ");
      // TODO answer confirmation
      answer = in.nextLine();
      m.put(statement, answer);
      out.println("If you are finished enter: Done. \nOtherwise, please enter another word or statement: ");
      statement = in.nextLine();
      if (statement.equalsIgnoreCase("done")) {
        done = true;
      }
